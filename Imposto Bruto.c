...
o imposto de renda cobrado de um funcionário pelo governo.
 Seu programa deverá ler o valor do salário mínimo, o n° de dependentes,
  o salário do funcionário e o taxa de imposto normal que já foi paga pelo
...
scanf("%f",&salariofunc);
printf("\nDigite quanto é o valor da taxa de imposto: ");
scanf("%f",&taxaimposto);
